    ...
    var s = {
      ...
      updateItems: function () {
        ...
        if (
          ...
          for (var i in e.options.itemsCustom)
            void 0 !== e.options.itemsCustom[i] &&
      ...
      gestures: function () {
        ...
        function a(i) {
          ...
          (l.newPosX = s(i).x - p.offsetX),
            (l.newPosY = s(i).y - p.offsetY),
            ...
            (l.newRelativeX > 8 ||
              (l.newRelativeX < -8 && !0 === l.browser.isTouch)) &&
          ...
          (l.newPosX = Math.max(
            Math.min(l.newPosX, l.newRelativeX / 5),
            l.maximumPixels + l.newRelativeX / 5
          )),
            !0 === l.browser.support3d
              ? l.transition3d(l.newPosX)
              : l.css2move(l.newPosX);
        }
        function r(o) {
          if (
            (((o = o.originalEvent || o || e.event).target =
            ...
            if (
              (l.goTo(i, !1, "drag"),
              p.targetElement === o.target && !0 !== l.browser.isTouch)
            ) {
        ...
        (l.isCssFinish = !0),
          l.$elem.on(l.ev_types.start, ".owl-wrapper", function (o) {
            ...
            if (!(l.itemsAmount <= l.options.items)) {
              ...
              if (!1 === l.isCss3Finish && !l.options.dragBeforeAnimFinish)
                return !1;
              !1 !== l.options.autoPlay && clearInterval(l.autoPlayInterval),
                !0 === l.browser.isTouch ||
              ...
              (p.relativePos = i.left),
                (p.offsetX = s(o).x - i.left),
                (p.offsetY = s(o).y - i.top),
                n("on"),
                (p.sliding = !1),
                (p.targetElement = o.target || o.srcElement);
            }
          });
      },
          ...
          if ("loaded" !== s.data("owl-loaded")) {
            ...
            "string" == typeof a.data("src")
              ? (s.data("owl-loaded") === i &&
                ...
                (!0 !== e.options.lazyFollow || n >= e.currentItem) &&
                  n < e.currentItem + e.options.items &&
                  a.length &&
                  e.lazyPreload(s, a))
      ...
      singleItemTransition: function () {
        ...
        s
          .css(((r = n), { position: "relative", left: r + "px" }))
          .addClass(e)
          .on(l, function () {
      ...
      addItem: function (t, e) {
        ...
        return (
          ...
          (0 === s.$elem.children().length
            ...
            : (s.unWrap(),
              (o = e === i || -1 === e ? -1 : e) >= s.$userItems.length ||
              -1 === o
