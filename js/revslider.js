...
(function (t, e) {
  ...
  (i.defaults = {
    ...
    (i.Instance.prototype = {
      on: function (t, e) {
        for (var i = t.split(" "), a = 0; i.length > a; a++)
          this.element.addEventListener(i[a], e, !1);
        return this;
      },
      off: function (t, e) {
        for (var i = t.split(" "), a = 0; i.length > a; a++)
          this.element.removeEventListener(i[a], e, !1);
        return this;
      },
      trigger: function (t, e) {
        ...
        var n = this.element;
        return (
          i.utils.hasParent(e.target, n) && (n = e.target),
          n.dispatchEvent(a),
          this
        );
      },
  ...
  (i.event = {
    bindDom: function (t, e, i) {
      for (var a = e.split(" "), n = 0; a.length > n; n++)
        t.addEventListener(a[n], i, !1);
    },
    onTouch: function (t, e, s) {
      ...
      this.bindDom(t, i.EVENT_TYPES[e], function (l) {
        ...
        if (!d.match(/mouse/) || !r) {
          (d.match(/touch/) ||
            d.match(/pointerdown/) ||
            (d.match(/mouse/) && 1 === l.which)) &&
            (n = !0),
            d.match(/touch|pointer/) && (r = !0);
          var h = 0;
          n &&
            (i.HAS_POINTEREVENTS && e != i.EVENT_END
              ? (h = i.PointerEvent.updatePointer(e, l))
              : d.match(/touch/)
              ? (h = l.touches.length)
              : r || (h = d.match(/up/) ? 0 : 1),
            h > 0 && e == i.EVENT_END
              ...
              : h || (e = i.EVENT_END),
            h || null === a ? (a = l) : (l = a),
            s.call(i.detection, o.collectEventData(t, e, l)),
            i.HAS_POINTEREVENTS &&
              e == i.EVENT_END &&
              (h = i.PointerEvent.updatePointer(e, l))),
            h || ((a = null), (n = !1), (r = !1), i.PointerEvent.reset());
        }
      });
    },
    ...
    collectEventData: function (t, e, a) {
      ...
      return (
        (a.type.match(/mouse/) ||
          i.PointerEvent.matchType(i.POINTER_MOUSE, a)) &&
          (r = i.POINTER_MOUSE),
        {
    ...
    (i.utils = {
      ...
      getCenter: function (t) {
        for (var e = [], i = [], a = 0, n = t.length; n > a; a++)
          e.push(t[a].pageX), i.push(t[a].pageY);
        return {
      ...
      getDirection: function (t, e) {
        return Math.abs(t.pageX - e.pageX) >= Math.abs(t.pageY - e.pageY)
          ? t.pageX - e.pageX > 0
            ? i.DIRECTION_LEFT
            : i.DIRECTION_RIGHT
          : t.pageY - e.pageY > 0
          ...
          for (var n = 0; a.length > n; n++)
            for (var r in e)
              e.hasOwnProperty(r) &&
                ((i = r),
                a[n] &&
                  (i = a[n] + i.substring(0, 1).toUpperCase() + i.substring(1)),
                (t.style[i] = e[r]));
          "none" == e.userSelect &&
    ...
    (i.detection = {
      ...
      detect: function (t) {
        if (this.current && !this.stopped) {
          ...
          for (
            var e = this.current.inst.options, a = 0, n = this.gestures.length;
            n > a;
            a++
          ) {
            ...
            if (
              !this.stopped &&
              !1 !== e[r.name] &&
              !1 === r.handler.call(r, t, this.current.inst)
            ) {
              this.stopDetect();
              break;
            }
      ...
      extendEventData: function (t) {
        ...
        if (
          ...
          e.touches = [];
          for (var a = 0, n = t.touches.length; n > a; a++)
            e.touches.push(i.utils.extend({}, t.touches[a]));
        }
      ...
      register: function (t) {
        var a = t.defaults || {};
        return (
          a[t.name] === e && (a[t.name] = !0),
          i.utils.extend(i.defaults, a, !0),
          (t.index = t.index || 1e3),
    ...
    (i.gestures.Tap = {
      ...
      handler: function (t, e) {
        if (t.eventType == i.EVENT_END) {
          ...
          a &&
            "tap" == a.name &&
            t.timeStamp - a.lastEvent.timeStamp <
              e.options.doubletap_interval &&
            t.distance < e.options.doubletap_distance &&
            (e.trigger("doubletap", t), (n = !0)),
            (!n || e.options.tap_always) &&
    ...
    (i.gestures.Drag = {
      ...
      handler: function (t, a) {
        if (i.detection.current.name != this.name && this.triggered)
          return a.trigger(this.name + "end", t), (this.triggered = !1), e;
        if (
          !(
            a.options.drag_max_touches > 0 &&
            t.touches.length > a.options.drag_max_touches
          )
        )
          switch (t.eventType) {
            case i.EVENT_START:
            ...
            case i.EVENT_MOVE:
              if (
                t.distance < a.options.drag_min_distance &&
                i.detection.current.name != this.name
              )
                return;
              (i.detection.current.name = this.name),
                (i.detection.current.lastEvent.drag_locked_to_axis ||
                  (a.options.drag_lock_to_axis &&
                    a.options.drag_lock_min_distance <= t.distance)) &&
                  (t.drag_locked_to_axis = !0);
              var n = i.detection.current.lastEvent.direction;
              t.drag_locked_to_axis &&
                n !== t.direction &&
                (t.direction = i.utils.isVertical(n)
                  ? 0 > t.deltaY
                    ? i.DIRECTION_UP
                    : i.DIRECTION_DOWN
                  : 0 > t.deltaX
                  ...
                  : i.DIRECTION_RIGHT),
                this.triggered ||
                  (a.trigger(this.name + "start", t), (this.triggered = !0)),
                a.trigger(this.name, t),
                a.trigger(this.name + t.direction, t),
                ((a.options.drag_block_vertical &&
                  i.utils.isVertical(t.direction)) ||
                  (a.options.drag_block_horizontal &&
                    !i.utils.isVertical(t.direction))) &&
                  t.preventDefault();
              break;
            case i.EVENT_END:
              this.triggered && a.trigger(this.name + "end", t),
                (this.triggered = !1);
          }
      },
    }),
    (i.gestures.Transform = {
      ...
      handler: function (t, a) {
        ...
        if (!(2 > t.touches.length))
          switch (
            (a.options.transform_always_block && t.preventDefault(),
            t.eventType)
          ) {
            case i.EVENT_START:
              this.triggered = !1;
            ...
            case i.EVENT_MOVE:
              ...
              if (
                a.options.transform_min_scale > n &&
                a.options.transform_min_rotation > r
              )
                return;
              (i.detection.current.name = this.name),
                this.triggered ||
                  (a.trigger(this.name + "start", t), (this.triggered = !0)),
                a.trigger(this.name, t),
                r > a.options.transform_min_rotation && a.trigger("rotate", t),
                n > a.options.transform_min_scale &&
                  (a.trigger("pinch", t),
                  a.trigger("pinch" + (1 > t.scale ? "in" : "out"), t));
              break;
            case i.EVENT_END:
              this.triggered && a.trigger(this.name + "end", t),
                (this.triggered = !1);
    ...
    (i.gestures.Touch = {
      ...
      handler: function (t, a) {
        return a.options.prevent_mouseevents && t.pointerType == i.POINTER_MOUSE
          ? (t.stopDetect(), e)
          : (a.options.prevent_default && t.preventDefault(),
            t.eventType == i.EVENT_START && a.trigger(this.name, t),
            e);
      },
    }),
    (i.gestures.Release = {
  ...
  (function (t, e) {
    "use strict";
    t !== e &&
      ((Hammer.event.bindDom = function (i, a, n) {
        t(i).on(a, function (t) {
          var i = t.originalEvent || t;
          i.pageX === e && ((i.pageX = t.pageX), (i.pageY = t.pageY)),
            i.target || (i.target = t.target),
            i.which === e && (i.which = i.button),
            i.preventDefault || (i.preventDefault = t.preventDefault),
            i.stopPropagation || (i.stopPropagation = t.stopPropagation),
            n.call(this, i);
        });
      }),
      ...
      (Hammer.Instance.prototype.trigger = function (e, i) {
        ...
        return (
          a.has(i.target).length && (a = t(i.target)),
          a.trigger({ type: e, gesture: i })
        );
      }),
      (t.fn.hammer = function (e) {
        return this.each(function () {
          var i = t(this),
            a = i.data("hammer");
          a
            ? a && e && Hammer.utils.extend(a.options, e)
            : i.data("hammer", new Hammer(this, e || {}));
        });
      }));
  ...
  (function (t) {
    ...
    if (!a.TweenLite) {
      var n,
        ...
        g = function (e, i, n, r) {
          ...
          (this.check = function (o) {
            for (var l, h, p, c, f = i.length, u = f; --f > -1; )
              (l = m[i[f]] || new g(i[f], [])).gsClass
                ? ((s[f] = l.gsClass), u--)
                : o && l.sc.push(this);
            if (0 === u && n)
              for (
                h = ("com.greensock." + e).split("."),
                  p = h.pop(),
                  c = d(h.join("."))[p] = this.gsClass = n.apply(n, s),
                  r &&
                    ((a[p] = c),
      ...
      var w = [0, 0, 1, 1],
        ...
        T = (b.register = function (t, e, i, a) {
          for (
            ...
            for (
              r = l[d],
                n = a ? _("easing." + r, null, !0) : h.easing[r] || {},
                s = p.length;
              --s > -1;
      ...
      for (
        ...
        (s = n[r] + ",Power" + r),
          T(new b(null, null, 1, r), s, "easeOut", !0),
          T(
            new b(null, null, 2, r),
            s,
            "easeIn" + (0 === r ? ",easeNone" : "")
          ),
          T(new b(null, null, 3, r), s, "easeInOut");
      ...
      ((s = C.prototype).addEventListener = function (t, e, i, a, n) {
        ...
        var r,
          ...
          h = 0;
        for (
          null == d && (this._listeners[t] = d = []), s = d.length;
          --s > -1;
          ...
          (r = d[s]),
            r.c === e && r.s === i
              ? d.splice(s, 1)
              : 0 === h && n > r.pr && (h = s + 1);
        d.splice(h, 0, { c: e, s: i, up: a, pr: n }),
          this !== o || l || o.wake();
      }),
      ...
      var P = t.requestAnimationFrame,
        ...
        E = O();
      for (r = (n = ["ms", "moz", "webkit", "o"]).length; --r > -1 && !P; )
        ...
        C.call(d),
          ...
          (d.fps = function (t) {
            return arguments.length
              ? ((r = 1 / ((i = t) || 60)), (s = this.time + r), void d.wake())
              : i;
          }),
          (d.useRAF = function (t) {
      ...
      A(),
        ...
        (s.timeScale = function (t) {
          ...
          if (
            ((t = t || p), this._timeline && this._timeline.smoothChildTiming)
          ) {
        ...
        (s.paused = function (t) {
          ...
          if (t != this._paused && this._timeline) {
            ...
            !t &&
              e.smoothChildTiming &&
              ((this._startTime += a), this._uncache(!1)),
      ...
      ((s = L.prototype = new S()).constructor = L),
        (s.kill()._gc = !1),
      ...
      var M = _(
          ...
          function (e, i, a) {
            ...
            if (
              ((this._overwrite = l =
                null == l
                  ? X[M.defaultOverwrite]
                  : "number" == typeof l
                  ? l >> 0
                  : X[l]),
              (o || e instanceof Array || (e.push && u(e))) &&
                "number" != typeof e[0])
            )
              for (
                this._targets = s = c.call(e, 0),
                  this._propLookup = [],
                  this._siblings = [],
                  n = 0;
                s.length > n;
                  ...
                  r
                    ? "string" != typeof r
                      ? r.length &&
                        ...
                        ? (s.splice(n--, 1),
                          (this._targets = s = s.concat(c.call(r, 0))))
                        : ((this._siblings[n] = F(r, this, !1)),
                          1 === l &&
                            this._siblings[n].length > 1 &&
                            W(r, this, null, 1, this._siblings[n]))
                      : ((r = s[n--] = M.selector(r)),
                        "string" == typeof r && s.splice(n + 1, 1))
                    : s.splice(n--, 1);
            else
              (this._propLookup = {}),
                (this._siblings = F(e, this, !1)),
                1 === l &&
      ...
      ((s = M.prototype = new S()).constructor = M),
        (s.kill()._gc = !1),
        (s.ratio = 0),
      ...
      var z = (M._internals = { isArray: u, isSelector: I }),
        R = (M._plugins = {}),
        N = (M._tweenLookup = {}),
        D = 0,
        Y = (z.reservedProps = {
      ...
      var F = function (t, e, i) {
          ...
          for (r = n.length; --r > -1; )
            (o = n[r]) === e ||
              ...
              (o._timeline !== e._timeline
                ? ((d = d || j(e, 0, u)), 0 === j(o, d, u) && (c[f++] = o))
                : h >= o._startTime &&
                  o._startTime + o.totalDuration() / o._timeScale > h &&
                  (((u || !o._initted) && 2e-10 >= h - o._startTime) ||
                    (c[f++] = o)));
          for (r = f; --r > -1; )
            (o = c[r]),
              2 === a && o._kill(i, t) && (s = !0),
        ...
        j = function (t, e, i) {
          for (
            var a = t._timeline, n = a._timeScale, r = t._startTime;
            a._timeline;

          ) {
            if (((r += a._startTime), (n *= a._timeScale), a._paused))
              return -100;
            a = a._timeline;
          }
          return (r /= n) > e
            ...
            ? p
            : (r += t.totalDuration() / t._timeScale / n) > e + p
            ? 0
            : r - e - p;
        };
      (s._init = function () {
          ...
          ((this._ease = l
            ? l instanceof b
              ? n.easeParams instanceof Array
                ? l.config.apply(l, n.easeParams)
                : l
              : "function" == typeof l
              ? new b(l, n.easeParams)
              : x[l] || M.defaultEase
            : M.defaultEase),
        ...
        (s._initProps = function (e, i, a, n) {
          ...
          for (r in this.vars) {
            if (((h = this.vars[r]), Y[r]))
              h &&
                (h instanceof Array || (h.push && u(h))) &&
                -1 !== h.join("").indexOf("{self}") &&
                (this.vars[r] = h = this._swapSelfInParams(h, this));
            else if (
              R[r] &&
              (l = new R[r]())._onInitTween(e, this.vars[r], this)
            ) {
              for (
                this._firstPT = d =
                  {
          ...
          return n && this._kill(n, e)
            ? this._initProps(e, i, a, n)
            : this._overwrite > 1 &&
              this._firstPT &&
              a.length > 1 &&
              W(e, this, i, this._overwrite, a)
            ? (this._kill(i, e), this._initProps(e, i, a, n))
            : o;
        }),
        (s.render = function (t, e, i) {
          var a,
          ...
          if (t >= l)
            (this._totalTime = this._time = l),
              ...
              this._reversed || ((a = !0), (n = "onComplete")),
              0 === l &&
                ((s = this._rawPrevTime),
                (0 === t || 0 > s || s === p) &&
                  s !== t &&
                  ((i = !0), s > p && (n = "onReverseComplete")),
                (this._rawPrevTime = s = !e || t || 0 === s ? t : p));
          else if (1e-7 > t)
            (this._totalTime = this._time = 0),
              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
              (0 !== o || (0 === l && this._rawPrevTime > p)) &&
                ((n = "onReverseComplete"), (a = this._reversed)),
              0 > t
                ? ((this._active = !1),
                  0 === l &&
                    (this._rawPrevTime >= 0 && (i = !0),
                    (this._rawPrevTime = s =
                      !e || t || 0 === this._rawPrevTime ? t : p)))
                : this._initted || (i = !0);
        ...
        (s._enabled = function (t, e) {
          if ((l || o.wake(), t && this._gc)) {
            ...
            if (a)
              for (i = a.length; --i > -1; )
                this._siblings[i] = F(a[i], this, !0);
            else this._siblings = F(this.target, this, !0);
          }
          return (
            S.prototype._enabled.call(this, t, e),
        ...
        (M.getTweensOf = function (t, e) {
          ...
          if (
            ...
            (u(t) || I(t)) && "number" != typeof t[0])
          ) {
            for (i = t.length, a = []; --i > -1; )
              a = a.concat(M.getTweensOf(t[i], e));
            for (i = a.length; --i > -1; )
              for (r = a[i], n = i; --n > -1; ) r === a[n] && a.splice(i, 1);
          } else
            for (a = F(t).concat(), i = a.length; --i > -1; )
        ...
        (M.killTweensOf = M.killDelayedCallsTo =
          function (t, e, i) {
            ...
            for (var a = M.getTweensOf(t, e), n = a.length; --n > -1; )
              a[n]._kill(i, t);
          });
      var B = _(
        "plugins.TweenPlugin",
      ...
      if (
        ...
        (B.API = 2),
        (s._firstPT = null),
        (s._addTween = function (t, e, i, a, n, r) {
          var s, o;
          return null != a &&
            (s =
              "number" == typeof a || "=" !== a.charAt(1)
                ? Number(a) - i
                : parseInt(a.charAt(0) + "1", 10) * Number(a.substr(2)))
            ? ((this._firstPT = o =
                {
                  _next: this._firstPT,
                  t: t,
        ...
        (M._onPluginEvent = function (t, e) {
          ...
          if ("_onInitAllProps" === t) {
            for (; o; ) {
              ...
              (o._prev = a ? a._prev : r) ? (o._prev._next = o) : (n = o),
        ...
        (B.activate = function (t) {
          for (var e = t.length; --e > -1; )
            t[e].API === B.API && (R[new t[e]()._propName] = t[e]);
          return !0;
        }),
        (v.plugin = function (t) {
        ...
        return (
          ...
          (p.staggerTo = function (t, e, n, s, o, d, p, c) {
            ...
            for (
              ...
              n.startAt && (n.startAt = l(n.startAt)),
                u.to(t[f], e, l(n), f * s);
            return this.add(u, o);
          }),
          (p.staggerFrom = function (t, e, i, a, n, r, s, o) {
            return (
              (i.immediateRender = 0 != i.immediateRender),
              (i.runBackwards = !0),
              this.staggerTo(t, e, i, a, n, r, s, o)
            );
          }),
          (p.staggerFromTo = function (t, e, i, a, n, r, s, o, l) {
            return (
              ...
              (a.immediateRender =
                0 != a.immediateRender && 0 != i.immediateRender),
              this.staggerTo(t, e, a, n, r, s, o, l)
            );
          }),
          ...
          (a.exportRoot = function (t, e) {
            ...
            for (
              null == e && (e = !0),
                o._remove(s, !0),
                s._startTime = 0,
                s._rawPrevTime = s._time = s._totalTime = o._time,
                n = o._first;
              n;
          ...
          (p.add = function (n, r, o, l) {
            ...
            if (
              ...
              if (n instanceof Array || (n && n.push && s(n))) {
                for (
                  o = o || "normal", l = l || 0, d = r, h = n.length, p = 0;
                  h > p;
                  p++
                )
                  s((c = n[p])) && (c = new a({ tweens: c })),
                    this.add(c, d),
                    "string" != typeof c &&
                      "function" != typeof c &&
                      ("sequence" === o
                        ? (d = c._startTime + c.totalDuration() / c._timeScale)
            ...
            if (
              ...
              for (f = this, u = f.rawTime() > n._startTime; f._timeline; )
                u && f._timeline.smoothChildTiming
          ...
          (p._remove = function (t, i) {
            ...
            return (
              a
                ? this._time > a._startTime + a._totalDuration / a._timeScale &&
                  ((this._time = this.duration()),
          ...
          (p._parseTimeOrLabel = function (e, i, a, n) {
            ...
            if (
              ...
              (i =
                ...
                (e =
                  r > 1
                    ? this._parseTimeOrLabel(e.substr(0, r - 1), 0, a)
                    : this.duration());
            }
            return Number(e) + i;
          }),
          ...
          (p.render = function (t, e, i) {
            ...
            if (
                ...
                ? ((this._totalTime = this._time = h),
                  this._reversed ||
                    ...
                    0 === this._duration &&
                      ...
                      this._first &&
                      ((d = !0),
                      this._rawPrevTime > n && (l = "onReverseComplete"))),
                  (this._rawPrevTime =
              ...
              if (
                ...
                for (a = this._last; a && ((s = a._prev), !this._paused || u); )
                  (a._active || (p >= a._startTime && !a._paused && !a._gc)) &&
                    (a._reversed
                      ? a.render(
                          (a._dirty ? a.totalDuration() : a._totalDuration) -
                            (t - a._startTime) * a._timeScale,
            ...
            for (var r = [], s = this._first, o = 0; s; )
              n > s._startTime ||
                (s instanceof i
                  ...
                  : (!1 !== a && (r[o++] = s),
                    !1 !== t &&
                      ((r = r.concat(s.getChildren(!0, e, a))),
                      (o = r.length)))),
                (s = s._next);
            return r;
          }),
          (p.getTweensOf = function (t, e) {
            for (
              var a = i.getTweensOf(t), n = a.length, r = [], s = 0;
              --n > -1;

            )
              (a[n].timeline === this || (e && this._contains(a[n]))) &&
                (r[s++] = a[n]);
            return r;
          }),
          ...
          (p.shiftChildren = function (t, e, i) {
            i = i || 0;
            for (var a, n = this._first, r = this._labels; n; )
          ...
          (p.totalDuration = function (t) {
            if (!arguments.length) {
              if (this._dirty) {
                for (var e, i, a = 0, n = this._last, r = 999999999999; n; )
                  (e = n._prev),
      ...
      function (t, e) {
        ...
        var d,
          ...
          W =
            ...
            (p =
              -1 !== F.indexOf("Safari") &&
              -1 === F.indexOf("Chrome") &&
              (-1 === g || Number(F.substr(g + 8, 1)) > 3)),
            (f = p && 6 > Number(F.substr(F.indexOf("Version/") + 8, 1))),
            (c = -1 !== F.indexOf("Firefox")),
            /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(F) &&
              (u = parseFloat(RegExp.$1)),
            (v.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>"),
            !!(m = v.getElementsByTagName("a")[0]) &&
              /^0.55/.test(m.style.opacity)),
          j = function (t) {
            return T.test(
              "string" == typeof t
                ? t
          ...
          Q = function (t, e, i, a, n) {
            ...
            return (
              d && (i = -i),
              "%" === a && -1 !== e.indexOf("border")
                ? (r = (i / 100) * (s ? t.clientWidth : t.clientHeight))
                : ((l.cssText =
                    "border:0 solid red;position:" +
                    $(t, "position") +
                    ";line-height:0;"),
                  "%" !== a && o.appendChild
                    ? (l[s ? "borderLeftWidth" : "borderTopWidth"] = i + a)
                    : ((o = t.parentNode || Y.body),
                      (l[s ? "width" : "height"] = i + a)),
                  o.appendChild(X),
                  (r = parseFloat(X[s ? "offsetWidth" : "offsetHeight"])),
                  o.removeChild(X),
                  0 !== r || n || (r = Q(t, e, i, a, !0))),
              d ? -r : r
            );
          ...
          G = function (t, e, i) {
            ...
            var a = "left" === e ? "Left" : "Top",
              n = $(t, "margin" + a, i);
            return (
              t["offset" + a] - (Q(t, e, parseFloat(n), n.replace(x, "")) || 0)
            );
          },
          J = function (t, e) {
            var i,
            ...
            if ((e = e || Z(t, null)))
              if ((i = e.length))
                for (; --i > -1; )
                  n[e[i].replace(E, A)] = e.getPropertyValue(e[i]);
          ...
          it = function (t, e, i) {
            ...
            for (i = i || Z(t, null); --r > -1; )
              (a -= parseFloat($(t, "padding" + n[r], i, !0)) || 0),
                (a -= parseFloat($(t, "border" + n[r] + "Width", i, !0)) || 0);
            return a;
          },
          at = function (t, e) {
                ...
                : ("," === t.charAt(t.length - 1) &&
                  ...
                  ot[t]
                    ...
                    ? ((t = t.match(_)),
                      ...
                      (e =
                        2 * (s = Number(t[2]) / 100) -
                        (i = 0.5 >= s ? s * (r + 1) : s + r - s * r)),
                      t.length > 3 && (t[3] = Number(t[3])),
                      (t[0] = lt(n + 1 / 3, e, i)),
                      (t[1] = lt(n, e, i)),
                      (t[2] = lt(n - 1 / 3, e, i)),
                      t)
                    : (((t = t.match(_) || ot.transparent)[0] = Number(t[0])),
                      (t[1] = Number(t[1])),
                      (t[2] = Number(t[2])),
                      t.length > 3 && (t[3] = Number(t[3])),
                      t))
        ...
        var pt = function (t, e, i, a) {
          ...
          ft =
            ((V._setPluginRatio = function (t) {
              ...
              for (
                var e, i, a, n, r = this.data, s = r.proxy, o = r.firstMPT;
                o;
                ...
                (e = s[o.v]),
                  ...
                  (o = o._next);
              if (
                (r.autoRotate && (r.autoRotate.rotation = s.rotation), 1 === t)
              )
                for (o = r.firstMPT; o; ) {
                  if ((i = o.t).type) {
                    if (1 === i.type) {
                      for (n = i.xs0 + i.s + i.xs1, a = 1; i.l > a; a++)
                        n += i["xn" + a] + i["xs" + (a + 1)];
                      i.e = n;
                    }
                  } else i.e = i.s + i.xs0;
          ...
          ut =
            ((V._parseToProxy = function (t, e, i, a, n, r) {
              var s,
                o,
                l,
                d,
                ...
                if (
                  ...
                  for (s = a.l; --s > 0; )
                    (l = "xn" + s),
                      ...
                      (f[o] = a.data[l]),
                      (c[o] = a[l]),
                      r || (d = new ft(a, l, o, d, a.rxp[l]));
                a = a._next;
              }
              return { proxy: c, end: f, firstMPT: d, pt: h };
            }),
            (V.CSSPropTween = function (t, e, a, n, s, o, l, d, h, p, c) {
              (this.t = t),
                ...
                (this.c = n),
                (this.n = l || e),
                t instanceof ut || r.push(this.n),
                (this.r = d),
                (this.type = o || 0),
                h && ((this.pr = h), (i = !0)),
                (this.b = void 0 === p ? a : p),
                (this.e = void 0 === c ? a + n : c),
                s && ((this._next = s), (s._prev = this));
            })),
          mt = (s.parseComplex = function (t, e, i, a, n, r, s, o, l, h) {
            (i = i || r || ""),
              (s = new ut(t, e, 0, 0, s, h ? 2 : 1, null, !1, o, i, a)),
              (a += "");
            var p,
              c,
              f,
            ...
            for (
              (-1 !== a.indexOf(",") || -1 !== i.indexOf(",")) &&
                ((P = P.join(" ").replace(z, ", ").split(" ")),
                (O = O.join(" ").replace(z, ", ").split(" ")),
                (E = P.length)),
                E !== O.length && (E = (P = (r || "").split(" ")).length),
                s.plugin = l,
                s.setRatio = h,
                p = 0;
              E > p;
              ...
              if (((u = P[p]), (m = O[p]), (y = parseFloat(u)), y || 0 === y))
                s.appendXtra(
                  "",
                  y,
                  nt(m, y),
              ...
              else if (n && ("#" === u.charAt(0) || ot[u] || k.test(u)))
                (C = "," === m.charAt(m.length - 1) ? ")," : ")"),
                  (u = dt(u)),
                  (m = dt(m)),
                  (b = u.length + m.length > 6),
                  b && !W && 0 === m[3]
                    ? ((s["xs" + s.l] += s.l ? " transparent" : "transparent"),
                      (s.e = s.e.split(O[p]).join("transparent")))
                    : (W || (b = !1),
                      s
                        .appendXtra(
                          b ? "rgba(" : "rgb(",
                        ...
                        .appendXtra("", u[1], m[1] - u[1], ",", !0)
                        .appendXtra("", u[2], m[2] - u[2], b ? "," : C, !0),
                      b &&
                        ((u = 4 > u.length ? 1 : u[3]),
                        s.appendXtra(
                          "",
            ...
            if (-1 !== a.indexOf("=") && s.data) {
              for (C = s.xs0 + s.data.s, p = 1; s.l > p; p++)
                C += s["xs" + p] + s.data["xn" + p];
              s.e = C + s["xs" + p];
            }
            return s.l || ((s.type = -1), (s.xs0 = s.e)), s.xfirst || s;
          }),
          gt = 9;
        for ((l = ut.prototype).l = l.pr = 0; --gt > 0; )
          (l["xn" + gt] = 0), (l["xs" + gt] = "");
        (l.xs0 = ""),
          (l._next =
            l._prev =
            ...
            l.rxp =
              null),
          (l.appendXtra = function (t, e, i, a, n, r) {
            var s = this,
              o = s.l;
            return (
              (s["xs" + o] += r && o ? " " + t : t || ""),
        ...
        var vt = function (t, e) {
          ...
          _t = (V._registerComplexSpecialProp = function (t, e, i) {
            ...
            var a,
              n = t.split(","),
              r = e.defaultValue;
            for (i = i || [r], a = 0; n.length > a; a++)
              (e.prefix = 0 === a && e.prefix),
                (e.defaultValue = i[a] || r),
                new vt(n[a], e);
          }),
          wt = function (t) {
            if (!o[t]) {
              ...
              _t(t, {
                parser: function (t, i, a, n, r, s, l) {
                  var d = (window.GreenSockGlobals || window).com.greensock
                    .plugins[e];
                  return d
                    ? (d._cssRegister(), o[a].parse(t, i, a, n, r, s, l))
                    : r;
                },
              });
            }
        ...
        ((l = vt.prototype).parseComplex = function (t, e, i, a, n, r) {
          ...
          if (
            ...
            for (
              d = l.length > o.length ? l.length : o.length, s = 0;
              d > s;
              s++
            )
              (e = o[s] = o[s] || this.dflt),
        ...
        var yt =
          ...
          Pt = function (t, e, i, a) {
            ...
            var n,
              ...
              C =
                (Ct &&
                  (parseFloat($(t, Tt, e, !1, "0 0 0").split(" ")[2]) ||
                    _.zOrigin)) ||
                0;
            for (
              bt
                ...
                : t.currentStyle &&
                  (n =
                    (n = t.currentStyle.filter.match(M)) && 4 === n.length
                      ? [
                          n[0].substr(4),
                          Number(n[2].substr(4)),
                          Number(n[1].substr(4)),
            ...
            if (16 === r.length) {
              ...
              if (
                (_.zOrigin &&
                  ((E = P * (A = -_.zOrigin) - r[12]),
                  (S = k * A - r[13]),
                  (A = O * A + _.zOrigin - r[14])),
                !i || a || null == _.rotationX)
              ) {
                var L,
                  I,
                  z,
                ...
                (_.rotationX = G * N),
                  G &&
                    ((L = B * (D = Math.cos(-G)) + P * (Y = Math.sin(-G))),
                    (I = U * D + k * Y),
                    (z = q * D + O * Y),
                    (P = B * -Y + P * D),
                    (k = U * -Y + k * D),
                  ...
                  G &&
                    ((X = -T > G || G > T),
                    (I = F * (D = Math.cos(-G)) - k * (Y = Math.sin(-G))),
                    (z = W * D - O * Y),
                    (k = F * Y + k * D),
                    (O = W * Y + O * D),
                    (Q = j * Y + Q * D),
                  ...
                  G &&
                    ((H = -T > G || G > T),
                    (V = V * (D = Math.cos(-G)) + B * (Y = Math.sin(-G))),
                    (I = F * D + U * Y),
                    (U = F * -Y + U * D),
                    (q = W * -Y + q * D),
                    (F = I)),
                  H && J
                    ...
                    : X && J && (_.rotationY = _.rotationX = 0),
                  (_.scaleX = (0 | (Math.sqrt(V * V + F * F) * b + 0.5)) / b),
                  (_.scaleY = (0 | (Math.sqrt(U * U + k * k) * b + 0.5)) / b),
                  (_.scaleZ = (0 | (Math.sqrt(q * q + O * O) * b + 0.5)) / b),
                  (_.skewX = 0),
                  (_.perspective = Q ? 1 / (0 > Q ? -Q : Q) : 0),
                  (_.x = E),
                  (_.y = S),
                  (_.z = A);
              }
              ...
              (_.x = r[4] || 0),
                (_.y = r[5] || 0),
                (h = Math.sqrt(tt * tt + et * et)),
                (p = Math.sqrt(at * at + it * it)),
                (c = tt || et ? Math.atan2(et, tt) * N : _.rotation || 0),
                (f = it || at ? Math.atan2(it, at) * N + c : _.skewX || 0),
                (u = h - Math.abs(_.scaleX || 0)),
                (m = p - Math.abs(_.scaleY || 0)),
                Math.abs(f) > 90 &&
                  270 > Math.abs(f) &&
                  (w
                    ? ((h *= -1),
          ...
          kt = function (t) {
            ...
            if (c) {
              ...
              if (
                (null != a.ox &&
                  ((y +=
                    (f = (a.oxp ? 0.01 * g * a.ox : a.ox) - g / 2) -
                    (f * o +
                      (m = (a.oyp ? 0.01 * v * a.oy : a.oy) - v / 2) * l)),
                  (b += m - (f * d + m * h))),
                _
                  ? (w +=
                      ", Dx=" +
                ...
                for (
                  ...
                  (P = et[gt]),
                    ...
                    (i =
                      -1 !== C.indexOf("px")
                        ? parseFloat(C)
                        : Q(this.t, P, parseFloat(C), C.replace(x, "")) || 0),
                    (k =
                      i !== a[P]
                        ? 2 > gt
                          ? -a.ieOffsetX
          ...
          Ot = function () {
            var t,
              ...
              A = C.perspective;
            if (c) {
              1e-4 > O && O > -1e-4 && (O = S = 2e-5),
                1e-4 > E && E > -1e-4 && (E = S = 2e-5),
                !A || C.z || C.rotationX || C.rotationY || (A = 0);
            }
            if (k || C.skewX)
              (_ = Math.cos(k)),
                (w = Math.sin(k)),
                ...
                (n = w),
                C.skewX &&
                  ((k -= C.skewX * R), (_ = Math.cos(k)), (w = Math.sin(k))),
                (e = -w),
                (r = _);
            else {
              if (!(C.rotationY || C.rotationX || 1 !== S || A))
                return void (P[bt] =
                  "translate3d(" +
                  C.x +
                  "px," +
            ...
            (h = 1),
              ...
              (k = C.rotationY * R) &&
                ...
                (n *= _)),
              (k = C.rotationX * R) &&
                ((y = e * (_ = Math.cos(k)) + i * (w = Math.sin(k))),
                (b = r * _ + s * w),
                (x = d * _ + h * w),
                (T = u * _ + m * w),
                (i = e * -w + i * _),
              ...
              1 !== E && ((e *= E), (r *= E), (d *= E), (u *= E)),
              1 !== O && ((t *= O), (n *= O), (l *= O), (f *= O)),
              g && ((a = i * (p -= g)), (o = s * p), (p = h * p + g)),
              (a = (y = (a += C.x) - (a |= 0))
                ? (0 | (y * v + (0 > y ? -0.5 : 0.5))) / v + a
                : a),
              (o = (y = (o += C.y) - (o |= 0))
                ? (0 | (y * v + (0 > y ? -0.5 : 0.5))) / v + o
                : o),
              (p = (y = (p += C.z) - (p |= 0))
                ? (0 | (y * v + (0 > y ? -0.5 : 0.5))) / v + p
                : p),
              (P[bt] =
                "matrix3d(" +
                [
          ...
          Et = function (t) {
            var e,
              ...
              s = this.data,
              o = this.t.style;
            return s.rotationX || s.rotationY || s.z || s.force3D
              ? ((this.setRatio = Ot), void Ot.call(this, t))
              : void (s.rotation || s.skewX
                  ? ((e = s.rotation * R),
                    (i = e - s.skewX * R),
                    (a = 1e5),
                    (n = s.scaleX * a),
        ...
        _t(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D",
          {
            parser: function (t, e, i, a, r, s, o) {
              ...
              var l,
                ...
                f,
                u,
                m = (a._transform = Pt(t, n, !0, o.parseTransform)),
                g = t.style,
                v = yt.length,
                _ = o,
                w = {};
              if ("string" == typeof _.transform && bt)
                (h = g.cssText),
                  (g[bt] = _.transform),
                  (g.display = "block"),
                  (l = Pt(t, null, !1)),
                ...
                if (
                  ...
                  if ("object" == typeof u) for (h in u) _[h] = u[h];
                  else _.rotation = u;
                (l.rotation = st(
                  "rotation" in _
                    ? _.rotation
                  ...
                  (l.skewX = null == _.skewX ? m.skewX : st(_.skewX, m.skewX)),
                  (l.skewY = null == _.skewY ? m.skewY : st(_.skewY, m.skewY)),
                  (d = l.skewY - m.skewY) &&
                    ((l.skewX += d), (l.rotation += d));
              }
              for (
                Ct && null != _.force3D && ((m.force3D = _.force3D), (f = !0)),
                  (c =
                    m.force3D ||
                    m.z ||
                    m.rotationX ||
                ...
                (i = yt[v]),
                  (p = l[i] - m[i]),
                  (p > 1e-6 || -1e-6 > p || null != D[i]) &&
                    ((f = !0),
                    (r = new ut(m, i, m[i], p, r)),
                    i in w && (r.e = w[i]),
                    (r.xs0 = 0),
                    (r.plugin = s),
                    a._overwriteProps.push(r.n));
              return (
                ((p = _.transformOrigin) || (Ct && c && m.zOrigin)) &&
                  (bt
                    ? ((f = !0),
                      (i = Tt),
                      (p = (p || $(t, i, n, !1, "50% 50%")) + ""),
                      ((r = new ut(g, i, 0, 0, r, -1, "transformOrigin")).b =
                        g[i]),
                      (r.plugin = s),
                      Ct
                        ? ((h = m.zOrigin),
                          ...
                          (r.xs0 =
                            ...
                            g[i] =
                              p[0] + " " + (p[1] || "50%") + " 0px"),
                          ((r = new ut(m, "zOrigin", 0, 0, r, -1, r.n)).b = h),
                          (r.xs0 = r.e = m.zOrigin))
                        : (r.xs0 = r.e = g[i] = p))
                    : at(p + "", m)),
                f &&
                  (a._transformType = c || 3 === this._transformType ? 3 : 2),
                r
              );
            },
            prefix: !0,
                ...
                this.p.indexOf("border") && (T[l] = q(T[l])),
                  ...
                  w
                    ? ((u = parseInt(c.charAt(0) + "1", 10)),
                      (c = c.substr(2)),
                      (u *= parseFloat(c)),
                      (v = c.substr((u + "").length - (0 > u ? 1 : 0)) || ""))
                    : ((u = parseFloat(c)), (v = c.substr((u + "").length))),
                  "" === v && (v = a[i] || _),
                  v !== _ &&
                    ((y = Q(t, "borderLeft", f, _)),
                    (b = Q(t, "borderTop", f, _)),
                    "%" === v
                      ? ((p = (y / m) * 100 + "%"), (h = (b / g) * 100 + "%"))
                      : "em" === v
          ...
          _t("backgroundSize", { defaultValue: "0 0", formatter: at }),
          _t("perspective", { defaultValue: "0px", prefix: !0 }),
          _t("perspectiveOrigin", { defaultValue: "50% 50%", prefix: !0 }),
          _t("transformStyle", { prefix: !0 }),
          _t("backfaceVisibility", { prefix: !0 }),
          _t("userSelect", { prefix: !0 }),
          _t("margin", {
            ...
            parser: function (t, e, i, a, r, s) {
              ...
              return (
                9 > u
                  ...
                  : ((o = this.format($(t, this.p, n, !1, this.dflt))),
                    (e = this.format(e))),
        ...
        var St = function (t) {
          ...
          100 === n &&
            ...
            -1 === a.indexOf("oader(")
              ...
              : ((i.filter = a.replace(P, "")), (e = !0))),
            e ||
              (this.xn1 && (i.filter = a = a || "alpha(opacity=" + n + ")"),
              -1 === a.indexOf("opacity")
                ? (0 === n && this.xn1) ||
                  (i.filter = a + " alpha(opacity=" + n + ")")
                : (i.filter = a.replace(T, "opacity=" + n)));
        };
          ...
          parser: function (t, e, i, a, r, s) {
            ...
            return (
              ...
              d &&
                ...
                (o = 0),
              W
                ? (r = new ut(l, "opacity", o, e - o, r))
                : (((r = new ut(l, "opacity", 100 * o, 100 * (e - o), r)).xn1 =
                    d ? 1 : 0),
                  (l.zoom = 1),
                  (r.type = 2),
        ...
        _t("className", {
          parser: function (t, e, a, r, s, o, l) {
            var d,
              ...
              m = t.style.cssText;
            if (
              (((s = r._classNamePT = new ut(t, a, 0, 0, s, 2)).setRatio = Lt),
              (s.pr = -11),
              (i = !0),
              (s.b = u),
              (h = J(t, n)),
            ...
            return (
              ...
              (s.e =
                "=" !== e.charAt(1)
                  ? e
                  : u.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") +
              ...
              r._tween._duration &&
                ...
                (s.data = d.firstMPT),
                (t.style.cssText = m),
                (s = s.xfirst = r.parse(t, d.difs, s, o))),
              s
            );
          },
        });
        var Mt = function (t) {
          if (
            ...
            if ("all" === this.e) (r.cssText = ""), (n = !0);
              ...
              for (e = this.e.split(","), a = e.length; --a > -1; )
                (i = e[a]),
                  o[i] &&
                    (o[i].parse === s
                      ? (n = !0)
                      : (i = "transformOrigin" === i ? Tt : o[i].p)),
                  At(r, i);
        ...
        for (
          _t("clearProps", {
            parser: function (t, e, a, n, r) {
              return (
                ((r = new ut(t, a, 0, 0, r, 2)).setRatio = Mt),
                (r.e = e),
                (r.pr = -10),
                (r.data = n._tween),
                (i = !0),
        ...
        ((l = s.prototype)._firstPT = null),
          (l._onInitTween = function (t, e, o) {
            ...
            if (
              ...
              "string" == typeof e &&
                ...
                (b.cssText = m + ";" + e),
                (l = K(t, l, J(t)).difs),
                !W && C.test(e) && (l.opacity = parseFloat(RegExp.$1)),
                (e = l),
                (b.cssText = m)),
              ...
              for (
                ...
                u = u._next;
              (w = new ut(t, "transform", 0, 0, null, 2)),
                this._linkCSSP(w, null, u),
                (w.setRatio = y && Ct ? Ot : bt ? Et : kt),
                (w.data = this._transform || Pt(t, n, !0)),
                r.pop();
            }
            if (i) {
              for (; c; ) {
                for (v = c._next, u = m; u && u.pr > c.pr; ) u = u._next;
                (c._prev = u ? u._prev : g) ? (c._prev._next = c) : (m = c),
                  (c._next = u) ? (u._prev = c) : (g = c),
                  (c = v);
              }
              this._firstPT = m;
            }
                    ...
                    (g && k.test(f))
                      ? (g ||
                          ...
                          (f =
                            ...
                            f.join(",") +
                            ")")),
                        (i = mt(_, s, c, f, !0, "transparent", i, 0, r)))
                      : !g || (-1 === f.indexOf(" ") && -1 === f.indexOf(","))
                      ? ((h = parseFloat(c)),
                        (u = h || 0 === h ? c.substr((h + "").length) : ""),
                        ("" === c || "auto" === c) &&
                          ("width" === s || "height" === s
                            ? ((h = it(t, s, n)), (u = "px"))
                            : "left" === s || "top" === s
                        ...
                        v
                          ? ((p = parseInt(f.charAt(0) + "1", 10)),
                            ...
                            (m = f.replace(x, "")))
                          : ((p = parseFloat(f)),
                            (m = (g && f.substr((p + "").length)) || "")),
                        "" === m && (m = s in a ? a[s] : u),
                        (f = p || 0 === p ? (v ? p + h : p) + m : e[s]),
                        u !== m &&
                          "" !== m &&
                          (p || 0 === p) &&
                          (h || 0 === h) &&
                  ...
                  if (
                    ...
                    if (1 === n.type)
                      if (((a = n.l), 2 === a))
                        ...
                        for (i = n.xs0 + e + n.xs1, a = 1; n.l > a; a++)
                          i += n["xn" + a] + n["xs" + (a + 1)];
                        n.t[n.p] = i;
                      }
                    else
          ...
          (l._enableTransforms = function (t) {
            (this._transformType = t || 3 === this._transformType ? 3 : 2),
              (this._transform = this._transform || Pt(this._target, n, !0));
          }),
        ...
        var It = function (t, e, i) {
          ...
          if (t.slice) for (n = t.length; --n > -1; ) It(t[n], e, i);
            ...
            for (a = t.childNodes, n = a.length; --n > -1; )
              (r = a[n]),
                (s = r.type),
                r.style && (e.push(J(r)), i && i.push(r)),
                (1 !== s && 9 !== s && 11 !== s) ||
                  !r.childNodes.length ||
                  It(r, e, i);
        };
        return (
          (s.cascadeTo = function (t, i, a) {
            var n,
              r,
              s,
              o = e.to(t, i, a),
  ...
  (function (t, e) {
    function a(i, n) {
      try {
        0 != n.hideThumbsUnderResoluition &&
          "thumb" == n.navigationType &&
          (n.hideThumbsUnderResoluition > t(window).width()
            ? t(".tp-bullets").css({ display: "none" })
            : t(".tp-bullets").css({ display: "block" }));
      } catch (t) {}
    ...
    function o(t) {
      var e = t
        ...
        n = e.width(),
        r =
          (i = e.find(".bullet:first").outerWidth(!0)) *
          t.find(">ul:first >li").length,
        s = 0 - a;
      s > 0 && (s = 0),
        s < 0 - r + n && (s = 0 - r + n),
        e.hasClass("over") || l(e, s, 200);
    }
    function l(t, e, i) {
    ...
    function d(e, i) {
      ...
      if ("thumb" == i.navigationType) {
        ...
        r.width(i.thumbWidth * i.thumbAmount * i.bw),
          r.height(i.thumbHeight * i.bh),
          r.parent().width(i.thumbWidth * i.thumbAmount * i.bw),
          r.parent().height(i.thumbHeight * i.bh);
      }
      ...
      "thumb" == i.navigationType &&
        ...
        "nexttobullets" == i.navigationArrows &&
          (s.prependTo(n).css({ float: "left" }),
          o.insertBefore(n.find(".tpclear")).css({ float: "left" }));
      var l = 0;
      "on" == i.forceFullWidth && (l = 0 - i.container.parent().offset().left),
        "none" != i.navigationArrows &&
          "nexttobullets" != i.navigationArrows &&
          (s.css({ position: "absolute" }),
          o.css({ position: "absolute" }),
          "center" == i.soloArrowLeftValign &&
            s.css({
              top: "50%",
              marginTop:
                i.soloArrowLeftVOffset - Math.round(s.innerHeight() / 2) + "px",
            }),
          "bottom" == i.soloArrowLeftValign &&
            s.css({ top: "auto", bottom: 0 + i.soloArrowLeftVOffset + "px" }),
          "top" == i.soloArrowLeftValign &&
            s.css({ bottom: "auto", top: 0 + i.soloArrowLeftVOffset + "px" }),
          "center" == i.soloArrowLeftHalign &&
            s.css({
              left: "50%",
              marginLeft:
                l +
                i.soloArrowLeftHOffset -
                Math.round(s.innerWidth() / 2) +
                "px",
            }),
          "left" == i.soloArrowLeftHalign &&
            s.css({ left: 0 + i.soloArrowLeftHOffset + l + "px" }),
          "right" == i.soloArrowLeftHalign &&
            s.css({ right: 0 + i.soloArrowLeftHOffset - l + "px" }),
          "center" == i.soloArrowRightValign &&
            o.css({
              top: "50%",
              marginTop:
                i.soloArrowRightVOffset -
                Math.round(o.innerHeight() / 2) +
                "px",
            }),
          "bottom" == i.soloArrowRightValign &&
            o.css({ top: "auto", bottom: 0 + i.soloArrowRightVOffset + "px" }),
          "top" == i.soloArrowRightValign &&
            o.css({ bottom: "auto", top: 0 + i.soloArrowRightVOffset + "px" }),
          "center" == i.soloArrowRightHalign &&
            o.css({
              left: "50%",
              marginLeft:
                l +
                i.soloArrowRightHOffset -
                Math.round(o.innerWidth() / 2) +
                "px",
            }),
          "left" == i.soloArrowRightHalign &&
            o.css({ left: 0 + i.soloArrowRightHOffset + l + "px" }),
          "right" == i.soloArrowRightHalign &&
            o.css({ right: 0 + i.soloArrowRightHOffset - l + "px" }),
          null != s.position() &&
            s.css({ top: Math.round(parseInt(s.position().top, 0)) + "px" }),
          null != o.position() &&
            o.css({ top: Math.round(parseInt(o.position().top, 0)) + "px" })),
        "none" == i.navigationArrows &&
          (s.css({ visibility: "hidden" }), o.css({ visibility: "hidden" })),
        "center" == i.navigationVAlign &&
          n.css({
            top: "50%",
            marginTop:
              i.navigationVOffset - Math.round(n.innerHeight() / 2) + "px",
          }),
        "bottom" == i.navigationVAlign &&
          n.css({ bottom: 0 + i.navigationVOffset + "px" }),
        "top" == i.navigationVAlign &&
          n.css({ top: 0 + i.navigationVOffset + "px" }),
        "center" == i.navigationHAlign &&
          n.css({
            left: "50%",
            marginLeft:
              l + i.navigationHOffset - Math.round(n.innerWidth() / 2) + "px",
          }),
        "left" == i.navigationHAlign &&
          n.css({ left: 0 + i.navigationHOffset + l + "px" }),
        "right" == i.navigationHAlign &&
          n.css({ right: 0 + i.navigationHOffset - l + "px" });
    }
    function h(i, a) {
      if (
        (a.container
          ...
          .css({ height: a.container.height() }),
        a.container
          .closest(".rev_slider_wrapper")
          .css({ height: a.container.height() }),
        (a.width = parseInt(a.container.width(), 0)),
        (a.height = parseInt(a.container.height(), 0)),
        (a.bw = a.width / a.startwidth),
        (a.bh = a.height / a.startheight),
        a.bh > a.bw && (a.bh = a.bw),
        a.bh < a.bw && (a.bw = a.bh),
        a.bw < a.bh && (a.bh = a.bw),
        a.bh > 1 && ((a.bw = 1), (a.bh = 1)),
        a.bw > 1 && ((a.bw = 1), (a.bh = 1)),
        (a.height = Math.round(a.startheight * (a.width / a.startwidth))),
        a.height > a.startheight &&
          "on" != a.autoHeight &&
          (a.height = a.startheight),
        "on" == a.fullScreen)
      ) {
        ...
        if (a.fullScreenOffsetContainer != e)
          try {
            var r = a.fullScreenOffsetContainer.split(",");
            t.each(r, function (e, i) {
              (n -= t(i).outerHeight(!0)) < a.minFullScreenHeight &&
                (n = a.minFullScreenHeight);
            });
          } catch (t) {}
        a.container.parent().height(n),
          a.container.css({ height: "100%" }),
          (a.height = n);
      } else a.container.height(a.height);
      (a.slotw = Math.ceil(a.width / a.slots)),
        "on" == a.fullSreen
          ? (a.sloth = Math.ceil(t(window).height() / a.slots))
          : (a.sloth = Math.ceil(a.height / a.slots)),
        "on" == a.autoHeight && (a.sloth = Math.ceil(i.height() / a.slots));
    }
    function p(t, i, a, n) {
      var s = t,
        o = s.find(".defaultimg"),
      ...
      o.data("currotate") != e && (d = o.data("currotate")),
        o.data("curscale") != e && (l = o.data("curscale")),
        h(o, i);
      var p = o.data("src"),
      ...
      if ("horizontal" == n) {
        ...
        for (var T = 0; T < i.slots; T++)
          s.append(
            ...
            l != e &&
              d != e &&
              TweenLite.set(s.find(".slot").last(), { rotationZ: d }),
            r(8) &&
              (s
                .find(".slot ")
                .last()
    ...
    function c(t, i, a) {
      ...
      s.data("currotate") != e && (l = s.data("currotate")),
        s.data("curscale") != e && (o = 100 * s.data("curscale")),
        h(s, i);
      var d = s.data("src"),
      ...
      b == e && (b = "cover"),
        ...
        T == e && (T = "center center"),
        "on" == n.data("kenburns") &&
          (b = o).toString().length < 4 &&
          (b = y(b, n, i));
      for (var C = 0; C < i.slots; C++) {
        w = 0;
        for (var P = 0; P < i.slots; P++)
          n.append(
            '<div class="slot" style="position:absolute;top:' +
              (fullyoff + w) +
              "px;left:" +
          ...
          setTimeout(function () {
            ...
            "center center" == t.data("bgposition") &&
              ...
              ("right top" != t.data("bgposition") &&
                ...
                i.css({ position: "absolute", top: "0px", right: "0px" }),
              ("right bottom" != t.data("bgposition") &&
                "bottom right" != t.data("bgposition")) ||
                i.css({ position: "absolute", bottom: "0px", right: "0px" }),
              ...
              ("left bottom" != t.data("bgposition") &&
                ...
                i.css({ position: "absolute", bottom: "0px", left: "0px" }),
    ...
    function m(i, a) {
      i.find("img, .defaultimg").each(function (i) {
        var n,
          r = t(this);
        r.data("lazyload") != r.attr("src") &&
        a < 3 &&
        r.data("lazyload") != e &&
        "undefined" != r.data("lazyload")
          ? r.data("lazyload") != e &&
            "undefined" != r.data("lazyload") &&
            (r.attr("src", r.data("lazyload")),
            ((n = new Image()).onload = function (t) {
          ...
          : (r.data("lazyload") !== e && "undefined" !== r.data("lazyload")) ||
            1 == r.data("lazydone") ||
            ...
            r.attr("src") != e && "undefined" != r.attr("src")
              ? (n.src = r.attr("src"))
              : (n.src = r.data("src")),
            n.complete &&
              (r.hasClass("defaultimg") && g(r, n), r.data("lazydone", 1)));
    ...
    function g(t, e) {
      ...
      i.data("owidth", a),
        i.data("oheight", n),
        i.find(".slotholder").data("owidth", a),
        i.find(".slotholder").data("oheight", n),
        i.data("loadeddone", 1);
    }
    function v(t, i) {
      try {
      ...
      (i.bannertimeronpause = !0),
        ...
        1 != n.data("lazydone")
          ? (r(8)
              ...
              : n.css({
                  backgroundImage:
                    'url("' + a.find(".defaultimg").data("lazyload") + '")',
                }),
            n.data("src", a.find(".defaultimg").data("lazyload")),
            n.data("lazydone", 1),
            n.data("orgw", 0),
            a.data("loadeddone", 1),
            TweenLite.set(t.find(".tp-loader"), {
              display: "block",
              opacity: 0,
            }),
            TweenLite.to(t.find(".tp-loader"), 0.3, { autoAlpha: 1 }),
            A(
              a,
              function () {
                _(i, n, t);
        ...
        (function (i, a) {
          function n() {
            t.each(v, function (t, e) {
              (e[0] != m && e[8] != m) || ((h = e[1]), (g = e[2]), (y = x)),
                (x += 1);
            });
          }
          i.trigger("revolution.slide.onbeforeswap"),
            (a.transition = 1),
            (a.videoplaying = !1);
          try {
            ...
            "on" == d.data("kenburns") &&
              (function (i, a) {
                ...
                s.find(".defaultimg").each(function () {
                  var i = t(this);
                  i.data("kenburn") != e && i.data("kenburn").restart(),
                    TweenLite.killTweensOf(i, !1),
                    TweenLite.set(i, { scale: 1, rotationZ: 0 }),
                    i.data("bgposition", s.data("bgposition")),
                    i.data("currotate", s.data("rotationstart")),
                    i.data("curscale", s.data("bgfit"));
                });
              })(i, a);
          a.ie &&
          ...
          u == e
            ? ((u = 0), o.data("nexttransid", u))
            : ((u += 1) == f.length && (u = 0), o.data("nexttransid", u));
          var m = f[u],
            g = 0;
          "slidehorizontal" == m &&
            ((m = "slideleft"), 1 == a.leftarrowpressed && (m = "slideright"));
          "slidevertical" == m &&
            ((m = "slideup"), 1 == a.leftarrowpressed && (m = "slidedown"));
          var v = [
            ...
            T = new Array();
          "random" == m &&
            (m = Math.round(Math.random() * v.length - 1)) > v.length - 1 &&
            (m = v.length - 1);
          "random-static" == m &&
            ((m = Math.round(Math.random() * _.length - 1)) > _.length - 1 &&
              (m = _.length - 1),
            (m = _[m]));
          "random-premium" == m &&
            ((m = Math.round(Math.random() * w.length - 1)) > w.length - 1 &&
              (m = w.length - 1),
            (m = w[m]));
          1 == a.isJoomla &&
            16 == m &&
            ((m = Math.round(Math.random() * w.length - 2) + 1) >
              w.length - 1 && (m = w.length - 1),
            (m = w[m]));
          n(),
            r(8) &&
              h > 15 &&
          ...
          (T = v[y]),
              ...
              .each(function () {
                ...
                e.removeClass("selected"),
                  ...
                  "nexttobullets" == a.navigationArrows
                    ? e.index() - 1 == a.next && e.addClass("selected")
                    : e.index() == a.next && e.addClass("selected");
              }),
            i.find(">li").each(function () {
              var e = t(this);
              e.index != a.act && e.index != a.next && e.css({ "z-index": 16 });
            }),
            s.css({ "z-index": 18 }),
            o.css({ "z-index": 20 }),
            o.css({ opacity: 0 }),
            s.index() != o.index() &&
              1 != a.firststart &&
              s.find(".tp-caption").each(function (e) {
                var i = t(this);
          ...
          k(o, a),
            o.data("slotamount") == e || o.data("slotamount") < 1
              ? ((a.slots = Math.round(12 * Math.random() + 4)),
                "boxslide" == m
                  ? (a.slots = Math.round(6 * Math.random() + 3))
                  : "flyin" == m &&
                    (a.slots = Math.round(4 * Math.random() + 1)))
              : (a.slots = o.data("slotamount"));
          o.data("rotate") == e
            ? (a.rotate = 0)
            : 999 == o.data("rotate")
            ? (a.rotate = Math.round(360 * Math.random()))
            : (a.rotate = o.data("rotate"));
          (!t.support.transition || a.ie || a.ie9) && (a.rotate = 0);
          1 == a.firststart && (s.css({ opacity: 0 }), (a.firststart = 0));
          (P += T[4]),
            (4 == h || 5 == h || 6 == h) && a.slots < 3 && (a.slots = 3);
          0 != T[3] && (a.slots = Math.min(a.slots, T[3]));
          9 == h && (a.slots = a.width / 20);
          10 == h && (a.slots = a.height / 20);
          "box" == T[5]
            ? (null != T[7] && c(l, a, T[7]), null != T[6] && c(d, a, T[6]))
            : ("vertical" != T[5] && "horizontal" != T[5]) ||
              (null != T[7] && p(l, a, T[7], T[5]),
              null != T[6] && p(d, a, T[6], T[5]));
          (h < 12 || h > 16) && o.css({ opacity: 1 });
          if (0 == h) {
          ...
          if (1 == h) {
            ...
            d.find(".defaultimg").css({ opacity: 0 }),
              d.find(".slotslide").each(function (e) {
                var i = t(this);
                (rand = Math.random() * P + 300),
                  (rand2 = 500 * Math.random() + 200),
                  rand + rand2 > S && (S = rand2 + rand2),
                  TweenLite.fromTo(
                    i,
                    rand / 1e3,
                    {
          ...
          if (4 == h || 5 == h) {
            ...
            l.find(".slotslide").each(function (e) {
              var i = t(this),
                n = (e * A) / a.slots;
              5 == h && (n = ((a.slots - e - 1) * A) / a.slots / 1.5),
                TweenLite.to(i, 3 * A, {
                  transformPerspective: 600,
                  top: 0 + a.height,
                  opacity: 0.5,
              ...
              d.find(".slotslide").each(function (e) {
                var n = t(this),
                  r = (e * A) / a.slots;
                5 == h && (r = ((a.slots - e - 1) * A) / a.slots / 1.5),
                  TweenLite.fromTo(
                    n,
                    3 * A,
                    {
          ...
          if (12 == h || 13 == h || 14 == h || 15 == h) {
            ...
            var M = a.width,
              I = a.height,
              z = d.find(".slotslide");
            ("on" != a.fullWidth && "on" != a.fullSreen) ||
              ((M = z.width()), (I = z.height()));
            var R = 0,
              N = 0;
            12 == h
              ? (R = M)
            ...
            1 == g && (D = 0),
              ...
              3 == g &&
                ((H = Power2.easeInOut),
                (V = Power1.easeInOut),
                s.css({ position: "absolute", "z-index": 20 }),
                o.css({ position: "absolute", "z-index": 15 }),
                (F = P / 1200)),
              (4 != g && 5 != g) || (Y = 0.6),
              6 == g && (Y = 1.4),
              (5 != g && 6 != g) ||
                ((X = 1.4), (D = 0), (M = 0), (I = 0), (R = 0), (N = 0)),
              6 == g && (X = 0.6),
              TweenLite.fromTo(
                z,
                F,
                { left: R, top: N, scale: X, opacity: D, rotation: a.rotate },
                {
                  opacity: 1,
                  rotation: 0,
                  left: 0,
                  ...
                  onComplete: function () {
                    b(i, a, d, l, o, s),
                      s.css({ position: "absolute", "z-index": 18 }),
          ...
          if (16 == h) {
            ...
            TweenLite.fromTo(
              ...
              setTimeout(function () {
                TweenLite.set(s.find(".tp-half-one"), { overflow: "hidden" });
              }, 50),
              TweenLite.fromTo(
                s.find(".tp-half-one"),
                P / 2e3,
              ...
              TweenLite.fromTo(
                ...
                { scale: G, rotation: U, y: I + I / 4, ease: Power2.easeInOut }
              ),
              TweenLite.fromTo(
                s.find(".tp-half-two"),
                P / 2e3,
            ...
            if (
              (d.find(".slotslide").each(function (e) {
                ...
                TweenLite.fromTo(
                  ...
                  TweenLite.to(n, 0.3, {
                    opacity: 1,
                    delay: (100 * e) / 1e3 + (0.2 * P) / 2e3 + P / 1e4,
                  });
              }),
              1 != C)
            ) {
          ...
          var et = {};
          (et.slideIndex = a.next + 1),
            i.trigger("revolution.slide.onchange", et),
            setTimeout(function () {
          ...
          e.data(
            ...
            TweenLite.fromTo(
              ...
              },
              {
                ...
                onUpdate: function () {
                  e.data("bgposition", e.css("backgroundPosition")),
                    r(8) ||
                      e.data(
                        "currotate",
                        (function (t) {
                          ...
                          if ("none" !== e)
                            var i = e.split("(")[1].split(")")[0].split(","),
                              ...
                              n = i[1],
                              r = Math.round(
                                Math.atan2(n, a) * (180 / Math.PI)
                              );
                          else var r = 0;
                          return r < 0 ? (r += 360) : r;
                        })(e)
                      ),
                    r(8) || e.data("curscale", e.css("backgroundSize"));
                },
              }
            )
          );
    ...
    function y(t, e, i) {
      ...
      return (
        t +
        "% " +
        ((e.data("oheight") * (i.container.width() / a)) /
          i.container.height()) *
          t +
        "%"
      );
    ...
    function b(t, e, i, a, n, r) {
      u(t, e),
        ...
        n.index() != r.index() && a.find(".defaultimg").css({ opacity: 0 }),
        (e.act = e.next),
        o(t),
        "on" == i.data("kenburns") && w(t, e);
    }
    function x(e) {
      ...
      if (e.data == YT.PlayerState.PLAYING) {
        ...
        "mute" == a.closest(".tp-caption").data("volume") && r.mute(),
          (s.videoplaying = !0),
          n.trigger("stoptimer"),
    ...
    function T(t, e) {
      ...
      t.find("video");
      r < n
        ? (t.width(a * n).height(a),
          t
            .css("top", 0)
            .css("left", -(a * n - i) / 2)
            .css("height", a))
        : (t.width(i).height(i / n),
          t
            .css("top", -(i / n - a) / 2)
            .css("left", 0)
            .css("height", i / n));
    ...
    function P(e, i) {
      ...
      return (
        t.each(a, function (t, i) {
          var a = (i = i.split(":"))[0],
            n = i[1];
          "rotationX" == a && (e.rotationX = parseInt(n, 0)),
            "rotationY" == a && (e.rotationY = parseInt(n, 0)),
            "rotationZ" == a && (e.rotationZ = parseInt(n, 0)),
            "rotationZ" == a && (e.rotation = parseInt(n, 0)),
            "scaleX" == a && (e.scaleX = parseFloat(n)),
            "scaleY" == a && (e.scaleY = parseFloat(n)),
            "opacity" == a && (e.opacity = parseFloat(n)),
            "skewX" == a && (e.skewX = parseInt(n, 0)),
            "skewY" == a && (e.skewY = parseInt(n, 0)),
            "x" == a && (e.x = parseInt(n, 0)),
            "y" == a && (e.y = parseInt(n, 0)),
            "z" == a && (e.z = parseInt(n, 0)),
            "transformOrigin" == a && (e.transformOrigin = n.toString()),
            "transformPerspective" == a &&
              (e.transformPerspective = parseInt(n, 0));
        }),
        e
      );
    }
    function k(i, a, r) {
      ...
      i.find(".tp-caption").each(function (i) {
        ...
        var l = a.bw;
        a.bh;
        "on" == a.fullScreen && (o = a.height / 2 - (a.startheight * a.bh) / 2),
          "on" == a.autoHeight &&
            (o = a.container.height() / 2 - (a.startheight * a.bh) / 2),
          o < 0 && (o = 0);
        var d = t(this),
          h = 0;
        if (
          (a.width < a.hideCaptionAtLimit && "on" == d.data("captionhidden")
            ? (d.addClass("tp-hidden-caption"), (h = 1))
            : a.width < a.hideAllCaptionAtLimit ||
              a.width < a.hideAllCaptionAtLilmit
            ? (d.addClass("tp-hidden-caption"), (h = 1))
            : d.removeClass("tp-hidden-caption"),
          0 == h)
        ) {
          d.data("linktoslide") == e ||
            d.hasClass("hasclicklistener") ||
            (d.addClass("hasclicklistener"),
            d.css({ cursor: "pointer" }),
            "no" != d.data("linktoslide") &&
              d.click(function () {
                var e = t(this).data("linktoslide");
                "next" != e && "prev" != e
                  ? (a.container.data("showus", e),
          ...
          if (
            (d.find("iframe").length > 0 || d.find("video").length > 0) &&
            ((1 != d.data("autoplayonlyfirsttime") &&
              "true" != d.data("autoplayonlyfirsttime")) ||
              d.data("autoplay", !0),
            d.find("iframe").each(function () {
              ...
              if (
                ((a.nextslideatend = d.data("nextslideatend")),
                d.data("thumbimage") != e &&
                  d.data("thumbimage").length > 2 &&
                  1 != d.data("autoplay") &&
                  !r &&
                ...
                if (i.hasClass("HasListener")) {
                  if (1 == d.data("autoplay")) {
                    ...
                    d.data(
                      "timerplay",
                      setTimeout(function () {
                        "on" == d.data("forcerewind") && g.seekTo(0),
                          g.playVideo();
                      }, d.data("start"))
                    );
                  }
                ...
                if (i.hasClass("HasListener")) {
                    ...
                    v = setInterval(function () {
                      if (
                        ...
                        d.data(
                          "timerplay",
                          setTimeout(function () {
                            "on" == d.data("forcerewind") && t.api("seekTo", 0),
                              t.api("play");
                          }, d.data("start"))
                        ),
                          clearInterval(v);
                  ...
                  for (
                    ...
                    f[decodeURIComponent(h[1])] = decodeURIComponent(h[2]);
                  c =
                    f.player_id != e
                      ? c.replace(f.player_id, p)
                      : c + "&player_id=" + p;
                  try {
                        ...
                        ($f(g).addEvent("ready", function () {
                          ...
                          (e = p),
                            ...
                            a.addEvent("ready", function (t) {
                              i && a.api("play"),
                                a.addEvent("play", function (t) {
                                  (r
                                    .find(".tp-bannertimer")
                                    .data("opt").videoplaying = !0),
                                    r.trigger("stoptimer"),
                                    "mute" ==
                                      n.closest(".tp-caption").data("volume") &&
                                      a.api("setVolume", "0");
                                }),
                                a.addEvent("finish", function (t) {
                                  ...
                                  (e.videoplaying = !1),
                                    r.trigger("playtimer"),
                                    r.trigger("revolution.slide.onvideoplay"),
                                    1 == e.nextslideatend &&
                                      e.container.revnext();
                                }),
                                a.addEvent("pause", function (t) {
                                  (r
                                    .find(".tp-bannertimer")
                                    .data("opt").videoplaying = !1),
                                    r.trigger("playtimer"),
                                    r.trigger("revolution.slide.onvideostop");
                                });
                            });
                        }),
                        clearInterval(v));
                  ...
                  var i = d.find("iframe").attr("id"),
                    a = setInterval(function () {
                      $f != e &&
                        typeof $f(i).api != e &&
                        void 0 !== $f(i).api &&
                        ($f(i).api("play"), clearInterval(a));
                    }, 100);
                });
              }
            }),
            d.find("video").length > 0 &&
              d.find("video").each(function (i) {
                var n = t(this),
                  r = this;
                n.parent().hasClass("html5vid") ||
                  n.wrap(
                ...
                r.addEventListener
                  ...
                  n.hasClass("HasListener") ||
                    (n.addClass("HasListener"),
                    r.addEventListener("play", function () {
                      s.addClass("videoisplaying"),
                        s.find(".tp-poster").remove(),
                        "mute" == d.data("volume") && (r.muted = !0),
                        a.container.trigger("revolution.slide.onvideoplay"),
                        (a.videoplaying = !0),
                        a.container.trigger("stoptimer");
                    }),
                    r.addEventListener("pause", function () {
                      s.removeClass("videoisplaying"),
                        (a.videoplaying = !1),
                        a.container.trigger("playtimer"),
                    ...
                    r.addEventListener("ended", function () {
                      s.removeClass("videoisplaying"),
                        ...
                        a.container.trigger("playtimer"),
                        a.container.trigger("revolution.slide.onvideostop"),
                        1 == a.nextslideatend && a.container.revnext();
                    })),
                  n.attr("poster") != e &&
                    0 == s.find(".tp-poster").length &&
                    s.append(
                  ...
                  n.attr("control") == e &&
                    0 == s.find(".tp-video-play-button").length &&
                    (s.append(
                      '<div class="tp-video-play-button"><i class="revicon-right-dir"></i><div class="tp-revstop"></div></div>'
                    ),
                    s.find(".tp-video-play-button").click(function () {
                      s.hasClass("videoisplaying") ? r.pause() : r.play();
                    })),
                  n.attr("control") == e &&
                    s.find("video, .tp-poster").click(function () {
                      s.hasClass("videoisplaying") ? r.pause() : r.play();
                    }),
                  1 == d.data("forcecover") &&
                    (T(s, a.container),
                    s.addClass("fullcoveredvideo"),
                    d.addClass("fullcoveredvideo")),
                  (1 == d.data("forcecover") ||
                    d.hasClass("fullscreenvideo")) &&
                  ...
                  s.data(
                    ...
                    setInterval(function () {
                      if (1 == s.data("metaloaded") || NaN != r.duration) {
                        clearInterval(s.data("interval")),
                          "none" != d.data("dottedoverlay") &&
                            d.data("dottedoverlay") != e &&
                            1 != d.find(".tp-dottedoverlay").length &&
                            s.append(
                              '<div class="tp-dottedoverlay ' +
                                d.data("dottedoverlay") +
                                '"></div>'
                            );
                        var i = 16 / 9;
                        if (
                          ("4:3" == d.data("aspectratio") && (i = 4 / 3),
                          s.data("mediaAspect", i),
                          1 == s.closest(".tp-caption").data("forcecover") &&
                            (T(s, a.container), s.addClass("fullcoveredvideo")),
                          n.css({ display: "block" }),
                          (a.nextslideatend = d.data("nextslideatend")),
                          1 == d.data("autoplay") || 1 == o)
                        ) {
                          t("body")
                            .find("#" + a.container.attr("id"))
                            .find(".tp-bannertimer");
                          setTimeout(function () {
                            (a.videoplaying = !0),
                              a.container.trigger("stoptimer");
                          }, 200),
                            "on" != d.data("forcerewind") ||
                              s.hasClass("videoisplaying") ||
                        ...
                        if (
                          (s.data("ww") == e && s.data("ww", n.attr("width")),
                          s.data("hh") == e && s.data("hh", n.attr("height")),
                          !d.hasClass("fullscreenvideo") &&
                            1 == d.data("forcecover"))
                        )
                          try {
                            s.width(s.data("ww") * a.bw),
                              s.height(s.data("hh") * a.bh);
                          } catch (t) {}
                        clearInterval(s.data("interval"));
                      }
                    }),
            ...
            setTimeout(function () {
              ...
              (1 != d.data("autoplayonlyfirsttime") &&
                "true" != d.data("autoplayonlyfirsttime")) ||
                (d.data("autoplay", !1), d.data("autoplayonlyfirsttime", !1));
          }
          var c = 0,
            f = 0;
          if (d.find("img").length > 0) {
            (g = d.find("img")).data("ww") == e && g.data("ww", g.width()),
              g.data("hh") == e && g.data("hh", g.height());
            var u = g.data("ww"),
              m = g.data("hh");
            g.width(u * a.bw),
              g.height(m * a.bh),
            ...
            var g,
              v = !1;
            0 == (g = d.find("iframe")).length &&
              ((g = d.find("video")), (v = !0)),
              g.css({ display: "block" }),
              d.data("ww") == e && d.data("ww", g.width()),
              d.data("hh") == e && d.data("hh", g.height());
            ...
            var w = a.width,
              y = a.height;
            if (
              (w > a.startwidth && (w = a.startwidth),
              y > a.startheight && (y = a.startheight),
              d.hasClass("fullscreenvideo"))
            ) {
              (s = 0), (o = 0), d.data("x", 0), d.data("y", 0);
              var b = a.height;
              "on" == a.autoHeight && (b = a.container.height()),
                d.css({ width: a.width, height: b });
            } else
              d.css({
            ...
            0 == v
              ? (g.width(u * a.bw), g.height(m * a.bh))
              : 1 == d.data("forcecover") ||
                d.hasClass("fullscreenvideo") ||
                (g.width(u * a.bw), g.height(m * a.bh)),
              (c = g.width()),
          ...
          "on" == a.fullScreenAlignForce && ((s = 0), (o = 0)),
            d.data("voffset") == e && d.data("voffset", 0),
            d.data("hoffset") == e && d.data("hoffset", 0);
          var A = d.data("voffset") * l,
            L = d.data("hoffset") * l,
            M = a.startwidth * l,
            I = a.startheight * l;
          "on" == a.fullScreenAlignForce &&
            ((M = a.container.width()), (I = a.container.height())),
            ("center" != d.data("x") && "center" != d.data("xcenter")) ||
              (d.data("xcenter", "center"),
              d.data("x", M / 2 - d.outerWidth(!0) / 2 + L)),
            ("left" != d.data("x") && "left" != d.data("xleft")) ||
              (d.data("xleft", "left"), d.data("x", 0 / l + L)),
            ("right" != d.data("x") && "right" != d.data("xright")) ||
              (d.data("xright", "right"),
              d.data("x", (M - d.outerWidth(!0) + L) / l)),
            ("center" != d.data("y") && "center" != d.data("ycenter")) ||
              (d.data("ycenter", "center"),
              d.data("y", I / 2 - d.outerHeight(!0) / 2 + A)),
            ("top" != d.data("y") && "top" != d.data("ytop")) ||
              (d.data("ytop", "top"), d.data("y", 0 / a.bh + A)),
            ("bottom" != d.data("y") && "bottom" != d.data("ybottom")) ||
              (d.data("ybottom", "bottom"),
              d.data("y", (I - d.outerHeight(!0) + A) / l)),
            d.data("start") == e && d.data("start", 1e3);
          var z = d.data("easing");
          z == e && (z = "Power1.easeOut");
          var R = d.data("start") / 1e3,
            N = d.data("speed") / 1e3;
          if ("center" == d.data("x") || "center" == d.data("xcenter"))
            var D = d.data("x") + s;
          else D = l * d.data("x") + s;
          if ("center" == d.data("y") || "center" == d.data("ycenter"))
            var Y = d.data("y") + o;
          else Y = a.bh * d.data("y") + o;
          if ((TweenLite.set(d, { top: Y, left: D, overwrite: "auto" }), !r)) {
            function X() {
              setTimeout(function () {
                d.css({
                  transform: "none",
            ...
            var V = d;
            d.data("mySplitText") != e && d.data("mySplitText").revert(),
              ("chars" != d.data("splitin") &&
                "words" != d.data("splitin") &&
                "lines" != d.data("splitin") &&
                "chars" != d.data("splitout") &&
                "words" != d.data("splitout") &&
                "lines" != d.data("splitout")) ||
                (d.find("a").length > 0
                  ? d.data(
                      "mySplitText",
                      new SplitText(d.find("a"), {
                ...
                d.addClass("splitted")),
              "chars" == d.data("splitin") && (V = d.data("mySplitText").chars),
              "words" == d.data("splitin") && (V = d.data("mySplitText").words),
              "lines" == d.data("splitin") && (V = d.data("mySplitText").lines);
            var F = C(),
              W = C();
            d.data("repeat") != e && (repeatV = d.data("repeat")),
              d.data("yoyo") != e && (yoyoV = d.data("yoyo")),
              d.data("repeatdelay") != e &&
                (repeatdelayV = d.data("repeatdelay")),
              d.hasClass("customin")
                ? (F = P(F, d.data("customin")))
                : d.hasClass("randomrotate")
                ? ((F.scale = 3 * Math.random() + 1),
                  (F.rotation = Math.round(200 * Math.random() - 100)),
                  (F.x = Math.round(200 * Math.random() - 100)),
                  (F.y = Math.round(200 * Math.random() - 100)))
                : d.hasClass("lfr") || d.hasClass("skewfromright")
                ? (F.x = 15 + a.width)
                : d.hasClass("lfl") || d.hasClass("skewfromleft")
                ? (F.x = -15 - c)
                : d.hasClass("sfl") || d.hasClass("skewfromleftshort")
                ? (F.x = -50)
                : d.hasClass("sfr") || d.hasClass("skewfromrightshort")
                ? (F.x = 50)
                : d.hasClass("lft")
                ? (F.y = -25 - f)
                : d.hasClass("lfb")
                ...
                : d.hasClass("sft")
                ? (F.y = -50)
                : d.hasClass("sfb") && (F.y = 50),
              d.hasClass("skewfromright") || d.hasClass("skewfromrightshort")
                ? (F.skewX = -85)
                : (d.hasClass("skewfromleft") ||
                    d.hasClass("skewfromleftshort")) &&
                  (F.skewX = 85),
              (d.hasClass("fade") ||
                d.hasClass("sft") ||
                d.hasClass("sfl") ||
              ...
              "safari" ==
                (function () {
                  ...
                  a &&
                    null != (t = i.match(/version\/([\.\d]+)/i)) &&
                    (a[2] = t[1]);
                  return (a = a
                    ? [a[1], a[2]]
                    : [e, navigator.appVersion, "-?"])[0];
                })().toLowerCase() && ((F.rotationX = 0), (F.rotationY = 0));
            var j = d.data("elementdelay") == e ? 0 : d.data("elementdelay");
            (W.ease = F.ease =
              d.data("easing") == e ? Power1.easeInOut : d.data("easing")),
              (F.data = new Object()),
              (F.data.oldx = F.x),
              (F.data.oldy = F.y),
              (W.data = new Object()),
            ...
            if (d.hasClass("customin"))
              V != d &&
                ...
                (W.onComplete = X()),
                (W.delay = R),
                H.add(B.staggerFromTo(V, N, F, W, j), "frame0");
            else if (
              ...
              for (i = 0; i < V.length; i++) {
                ...
                t.extend(U, F),
                  ...
                  (F.y = Math.round(200 * Math.random() - 100)),
                  0 != i && (q.delay = R + i * j),
                  H.append(TweenLite.fromTo(V[i], N, U, q), "frame0");
              }
                ...
                if (a.length > 0) {
                    ...
                    return (
                      t.each(n, function (t, e) {
                        var i = (e = e.split(":"))[0],
                          n = e[1];
                        "typ" == i && (a.typ = n),
                          "speed" == i && (a.speed = parseInt(n, 0) / 1e3),
                          "start" == i && (a.start = parseInt(n, 0) / 1e3),
                          "elementdelay" == i &&
                            (a.elementdelay = parseFloat(n)),
                          "ease" == i && (a.ease = n);
                      }),
                      a
                    );
                  ...
                  !(function (t, i, a, n, r) {
                    var s = t.data("timeline"),
                      ...
                      l = t;
                    "chars" == a.typ
                      ? (l = t.data("mySplitText").chars)
                      : "words" == a.typ
                      ? (l = t.data("mySplitText").words)
                      : "lines" == a.typ && (l = t.data("mySplitText").lines);
                    (a.animation.ease = a.ease),
                      a.animation.rotationZ != e &&
                        (a.animation.rotation = a.animation.rotationZ);
                    (a.animation.data = new Object()),
                      (a.animation.data.oldx = a.animation.x),
                      (a.animation.data.oldy = a.animation.y),
                      (a.animation.x = a.animation.x * r),
                      (a.animation.y = a.animation.y * r),
                      s.add(
                        o.staggerTo(l, a.speed, a.animation, a.elementdelay),
                        a.start
                      ),
                      s.addLabel(n, a.start),
                      t.data("timeline", s);
                  })(d, 0, n, "frame" + (i + 10), l);
                }
              });
            ...
            (H = d.data("timeline")),
              d.data("end") != e
                ? E(d, a, d.data("end") / 1e3, F, "frame99", l)
                : E(d, a, 999999, F, "frame99", l),
              (H = d.data("timeline")),
              d.data("timeline", H);
          }
        }
        if (r && d.data("timeline") != e) {
          ...
          t.each(Q, function (t, i) {
            if (i.vars.data != e) {
              ...
              else 1 == i.progress() && TweenLite.set(i.target, { x: a, y: n });
            }
          });
        }
      }),
      ...
      t.data("fsize") == e &&
        ...
        t.hasClass("tp-splitted") ||
          ...
          "none" != t.data("maxheight") &&
            t.css({ maxHeight: t.data("maxheight") * i.bh + "px" }),
          "none" != t.data("maxwidth") &&
            t.css({ maxWidth: t.data("maxwidth") * i.bw + "px" }));
    }
      ...
      if (
        ...
        t.hasClass("skewtoright") || t.hasClass("skewtorightshort")
          ...
          t.hasClass("ltr") || t.hasClass("skewtoright")
            ...
            ? ((d.y = 50), (d.opacity = 0))
            : t.hasClass("randomrotateout")
            ? ((d.x = Math.random() * i.width),
              (d.y = Math.random() * i.height),
              (d.scale = 2 * Math.random() + 0.3),
              (d.rotation = 360 * Math.random() - 180),
              (d.opacity = 0))
            : t.hasClass("fadeout") && (d.opacity = 0),
          t.hasClass("skewtorightshort")
            ? (d.x = 270)
            : t.hasClass("skewtoleftshort") && (d.x = -270),
          (d.data = new Object()),
          (d.data.oldx = d.x),
          (d.data.oldy = d.y),
          (d.x = d.x * s),
    ...
    function S(i, a) {
      if (
        ((a.cd = 0),
        (a.loop = 0),
        a.stopAfterLoops != e && a.stopAfterLoops > -1
          ? (a.looptogo = a.stopAfterLoops)
          : (a.looptogo = 9999999),
        a.stopAtSlide != e && a.stopAtSlide > -1
          ? (a.lastslidetoshow = a.stopAtSlide)
          : (a.lastslidetoshow = 999),
        (a.stopLoop = "off"),
        0 == a.looptogo && (a.stopLoop = "on"),
        a.slideamount > 1 && (0 != a.stopAfterLoops || 1 != a.stopAtSlide))
      ) {
        var r = i.find(".tp-bannertimer");
        function s() {
          0 == t("body").find(i).length &&
            (!(function (e, i) {
            ...
            1 == i.data("conthover-changed") &&
              ((a.conthover = i.data("conthover")),
              i.data("conthover-changed", 0)),
            (a.act = a.next),
            (a.next = a.next + 1),
            a.next > i.find(">ul >li").length - 1 &&
              ((a.next = 0),
              (a.looptogo = a.looptogo - 1),
              a.looptogo <= 0 && (a.stopLoop = "on")),
            "on" == a.stopLoop && a.next == a.lastslidetoshow - 1
              ? (i.find(".tp-bannertimer").css({ visibility: "hidden" }),
                i.trigger("revolution.slide.onstop"))
              : r.data("tween").restart(),
            v(i, a);
        }
        i.on("stoptimer", function () {
          r.data("tween").pause(),
            "on" == a.hideTimerBar && r.css({ visibility: "hidden" });
        }),
          i.on("starttimer", function () {
            1 != a.conthover &&
              1 != a.videoplaying &&
              a.width > a.hideSliderAtLimit &&
              1 != a.bannertimeronpause &&
              1 != a.overnav &&
              (("on" == a.stopLoop && a.next == a.lastslidetoshow - 1) ||
                (r.css({ visibility: "visible" }), r.data("tween").play())),
              "on" == a.hideTimerBar && r.css({ visibility: "hidden" });
          }),
          ...
          r.data(
            ...
            TweenLite.fromTo(
              ...
              a.delay / 1e3,
              { width: "0%" },
              { width: "100%", ease: Linear.easeNone, onComplete: s, delay: 1 }
            )
          ),
          r.data("opt", a),
          i.hover(
            function () {
              "on" != a.onHoverStop ||
                ...
                i
                  .find(">ul >li:eq(" + a.next + ") .slotholder")
                  .find(".defaultimg")
                  .each(function () {
                    var i = t(this);
    ...
    t.fn.extend({
      revolution: function (i) {
        return (
          ...
          (i = t.extend({}, t.fn.revolution.defaults, i)),
          this.each(function () {
            var p = i;
            (p.desktop = !navigator.userAgent.match(
              /(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i
            )),
              "on" != p.fullWidth &&
                "on" != p.fullScreen &&
                (p.autoHeight = "off"),
              "on" == p.fullScreen && (p.autoHeight = "on"),
              "on" != p.fullWidth &&
                "on" != p.fullScreen &&
                (forceFulWidth = "off");
            var c,
            ...
            if (
              ("on" == p.fullWidth &&
                "off" == p.autoHeight &&
                w.css({ maxHeight: p.startheight + "px" }),
              n() &&
                "on" == p.hideThumbsOnMobile &&
                "thumb" == p.navigationType &&
                (p.navigationType = "none"),
              n() &&
                "on" == p.hideBulletsOnMobile &&
                "bullet" == p.navigationType &&
                (p.navigationType = "none"),
              n() &&
                "on" == p.hideBulletsOnMobile &&
                "both" == p.navigationType &&
                (p.navigationType = "none"),
              n() &&
                "on" == p.hideArrowsOnMobile &&
                (p.navigationArrows = "none"),
              "on" == p.forceFullWidth)
            ) {
            ...
            try {
              p.hideThumbsUnderResolution > t(window).width() &&
              0 != p.hideThumbsUnderResolution
                ? w
                    .parent()
            ...
            if (!w.hasClass("revslider-initialised")) {
              w.addClass("revslider-initialised"),
                w.attr("id") == e &&
                  w.attr(
                    "id",
                ...
                (p.firefox13 = !1),
                (p.ie = !t.support.opacity),
                (p.ie9 = 9 == document.documentMode),
                (p.origcd = p.delay);
              ...
              1 == C &&
                ...
                w.find(".caption").each(function () {
                  t(this).addClass("tp-caption");
                }),
                n() &&
                  w.find(".tp-caption").each(function () {
                    1 == t(this).data("autoplay") &&
                      t(this).data("autoplay", !1);
                  });
              var k = 0,
                O = 0,
                E = "http";
              if (
                ("https:" === location.protocol && (E = "https"),
                  ...
                  try {
                    if (t(this).attr("src").indexOf("vim") > 0 && 0 == O) {
                      ...
                      t("head")
                        ...
                        .each(function () {
                          t(this).attr("src") ==
                            E + "://a.vimeocdn.com/js/froogaloop2.min.js" &&
                            (n = !1);
                        }),
                        n && a.parentNode.insertBefore(i, a);
                    }
                ...
                for (var A = 0; A < w.find(">ul:first-child >li").length; A++) {
                  var L = Math.round(
                    Math.random() * w.find(">ul:first-child >li").length
                  );
                  w.find(">ul:first-child >li:eq(" + L + ")").prependTo(
                    w.find(">ul:first-child")
                  );
                }
              (p.slots = 4),
                (p.act = -1),
                (p.next = 0),
                p.startWithSlide != e && (p.next = p.startWithSlide);
              var M = (function (t) {
                for (
                  var e,
                    i = [],
              ...
              if (M.length < 9 && M.split("slide").length > 1) {
                ...
                I < 1 && (I = 1),
                  I > w.find(">ul:first >li").length &&
                    (I = w.find(">ul:first >li").length),
                  (p.next = I - 1);
              }
              (p.firststart = 1),
                p.navigationHOffset == e && (p.navOffsetHorizontal = 0),
                p.navigationVOffset == e && (p.navOffsetVertical = 0),
                w.append(
                  '<div class="tp-loader ' +
                    p.spinner +
                    '"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>'
                ),
                0 == w.find(".tp-bannertimer").length &&
                  w.append(
                    '<div class="tp-bannertimer" style="visibility:hidden"></div>'
                  );
              var z = w.find(".tp-bannertimer");
              if (
                (z.length > 0 && z.css({ width: "0%" }),
                w.addClass("tp-simpleresponsive"),
                (p.container = w),
                (p.slideamount = w.find(">ul:first >li").length),
                0 == w.height() && w.height(p.startheight),
                (p.startwidth != e && 0 != p.startwidth) ||
                  (p.startwidth = w.width()),
                (p.startheight != e && 0 != p.startheight) ||
                  (p.startheight = w.height()),
                (p.width = w.width()),
                (p.height = w.height()),
                (p.bw = p.startwidth / w.width()),
                (p.bh = p.startheight / w.height()),
                p.width != p.startwidth &&
                  ((p.height = Math.round(
                    p.startheight * (p.width / p.startwidth)
                  )),
                  w.height(p.height)),
                0 != p.shadow)
              ) {
                ...
                y = 0;
                "on" == p.forceFullWidth &&
                  (y = 0 - p.container.parent().offset().left),
                  w
                    .parent()
                    .find(".tp-bannershadow")
                    .css({ width: p.width, left: y });
              }
              w.find("ul").css({ display: "none" });
              w.find("ul").css({ display: "block" }),
                (_ = p),
                (g = w).find(".tp-caption").each(function () {
                ...
                "on" == _.autoHeight &&
                  ...
                  g.css({ maxHeight: "none" }),
                  g.parent().css({ maxHeight: "none" })),
                g.find(">ul:first >li").each(function (i) {
                  ...
                  if (
                    ...
                    a.data("target") != e && (r = a.data("target")),
                      "slide" == n
                        ? a.append(
                ...
                g.find(">ul:first >li >img").each(function (i) {
                  ...
                  a.addClass("defaultimg"),
                    (a.data("lazyload") != e && 1 != a.data("lazydone")) ||
                      h(a, _),
                    a.wrap(
                ...
                "off" != p.parallax &&
                  ((m = p),
                  (u = w).find(">ul:first-child >li").each(function () {
                    for (var e = t(this), i = 0; i < 10; i++)
                      e.find(".rs-parallaxlevel-" + i).wrapAll(
                ...
                p.slideamount > 1 &&
                  (function (e, i) {
                    ...
                    e.find(">ul:first >li").each(function (t) {
                      e
                        .find(">ul:first >li:eq(" + t + ") img:first")
                        .attr("src"),
                      ...
                      a.find(".bullet").each(function (a) {
                        var n = t(this);
                        a == i.slideamount - 1 && n.addClass("last"),
                          0 == a && n.addClass("first"),
                          n.click(function () {
                            var t = !1;
                ...
                p.slideamount > 1 &&
                  (function (i, a) {
                    var n = i.parent();
                    ("thumb" != a.navigationType && "both" != a.navsecond) ||
                      n.append(
                    ...
                    var r = n.find(
                      ...
                      d = r.parent();
                    d.width(a.thumbWidth * a.thumbAmount),
                      d.height(a.thumbHeight),
                      d.parent().width(a.thumbWidth * a.thumbAmount),
                      d.parent().height(a.thumbHeight),
                    ...
                    r.find(".bullet").each(function (e) {
                      var n = t(this);
                      e == a.slideamount - 1 && n.addClass("last"),
                        0 == e && n.addClass("first"),
                        n.width(a.thumbWidth),
                        n.height(a.thumbHeight),
                        h < n.outerWidth(!0) && (h = n.outerWidth(!0)),
                        n.click(function () {
                          0 == a.transition &&
                            n.index() != a.act &&
                            ((a.next = n.index()), s(a, i));
                        });
                    });
                ...
                "on" == p.keyboardNavigation &&
                  ((c = w),
                  (f = p),
                  t(document).keydown(function (t) {
                    0 == f.transition &&
                      39 == t.keyCode &&
                      (c.data("showus") != e && -1 != c.data("showus")
                        ? (f.next = c.data("showus") - 1)
                        : (f.next = f.next + 1),
                      c.data("showus", -1),
                      f.next >= f.slideamount && (f.next = 0),
                      f.next < 0 && (f.next = 0),
                      f.act != f.next && s(f, c)),
                      0 == f.transition &&
                        37 == t.keyCode &&
                        ((f.next = f.next - 1),
                        (f.leftarrowpressed = 1),
                        f.next < 0 && (f.next = f.slideamount - 1),
                        s(f, c));
                  }),
                  d(c, f)),
                (function (e, i) {
              ...
              try {
                0 != p.hideThumbsUnderResoluition &&
                  "thumb" == p.navigationType &&
                  (p.hideThumbsUnderResoluition > t(window).width()
                    ? t(".tp-bullets").css({ display: "none" })
                    : t(".tp-bullets").css({ display: "block" }));
              } catch (t) {}
              w.find(".tp-scrollbelowslider").on("click", function () {
                ...
                t("body,html").animate(
                  {
                    scrollTop:
                      w.offset().top + w.find(">ul >li").height() - e + "px",
                  },
                  { duration: 400 }
                );
              });
              var R = w.parent();
              t(window).width() < p.hideSliderAtLimit &&
                (w.trigger("stoptimer"),
                "none" != R.css("display") &&
      ...
      revpause: function (e) {
        return this.each(function () {
          ...
          e.data("conthover", 1),
            ...
            (e.parent().find(".tp-bannertimer").data("opt").bannertimeronpause =
              !0),
            e.trigger("stoptimer");
        });
      },
    ...
    var e = t.GreenSockGlobals || t,
      ...
      o = function (t, e, i, a) {
        ...
        return (
          (i = i || r(t, null))
            ? (n =
                (t = i.getPropertyValue(e.replace(s, "-$1").toLowerCase())) ||
                i.length
                  ? t
                  : i[e])
            : t.currentStyle && (n = (i = t.currentStyle)[e]),
          a ? n : parseInt(n, 10) || 0
        );
      },
      l = function (t) {
      ...
      u = function (t, e, i, s, l) {
        ...
        var p,
          ...
          q = e.linesClass;
        for (U && (q = q.split("++").join("")), u = j(), m = 0; F > m; m++)
          (v = P.charAt(m)),
            ")" === v && P.substr(m, 20) === d
              ? ((u += W + "<BR/>"), m !== F - 1 && (u += " " + j()), (m += 19))
              : " " === v && " " !== P.charAt(m - 1) && m !== F - 1
              ? ((u += W), m !== F - 1 && (u += L + j()))
              : (u += S && " " !== v ? B() + v + "</div>" : v);
        for (
          t.innerHTML = u + W,
            F = (g = t.getElementsByTagName("*")).length,
            _ = [],
            m = 0;
          F > m;
          m++
            ...
            (w = _[m]),
              ...
              (f || A || (S && !E)) &&
                ...
                A &&
                  ...
                  (w._h = w.offsetHeight)),
                O &&
                  ((E !== f && S) || (p.push(w), (w._x -= z)),
                  f && m && (_[m - 1]._wordEnd = !0)));
        for (m = 0; F > m; m++)
          (w = _[m]),
            (f = w.parentNode === t),
            "BR" !== w.nodeName
              ? (A &&
                ...
                E
                  ? f
                    ...
                    : S && i.push(w)
                  : f
                  ? (t.removeChild(w), _.splice(m--, 1), F--)
                  : !f &&
                    S &&
                    ((y = !O && !A && w.nextSibling),
                    t.appendChild(w),
        ...
        if (O) {
          for (
            A &&
              ...
              t.appendChild(b),
              (T = b.offsetWidth + "px"),
              (y = b.offsetParent === t ? 0 : t.offsetLeft),
              t.removeChild(b)),
              x = t.style.cssText,
          ...
          for (C = !A || (!E && !S), m = 0; O.length > m; m++) {
            for (
              p = O[m],
                (b = n.createElement("div")).style.cssText =
                  "display:block;text-align:" +
                  X +
                  ";position:" +
                  (A ? "absolute;" : "relative;"),
                q && (b.className = q + (U ? m + 1 : "")),
                l.push(b),
                F = p.length,
                g = 0;
              F > g;
              ...
              "BR" !== p[g].nodeName &&
                ((w = p[g]),
                b.appendChild(w),
                C && (w._wordEnd || E) && b.appendChild(n.createTextNode(" ")),
                A &&
                  (0 === g &&
                    ((b.style.top = w._y + "px"),
                    (b.style.left = z + y + "px")),
                  (w.style.top = "0px"),
                  y && (w.style.left = w._x - y + "px")));
            E ||
              S ||
              (b.innerHTML = a(b).split(String.fromCharCode(160)).join(" ")),
              A && ((b.style.width = T), (b.style.height = w._h + "px")),
              t.appendChild(b);
          }
          t.style.cssText = x;
        }
        A &&
          (H > t.clientHeight &&
            ((t.style.height = H - D + "px"),
            H > t.clientHeight && (t.style.height = H + R + "px")),
          V > t.clientWidth &&
            ((t.style.width = V - Y + "px"),
            V > t.clientWidth && (t.style.width = V + N + "px")));
      },
      m = f.prototype;
    (m.split = function (t) {
      ...
      for (var e = 0; this.elements.length > e; e++)
        (this._originals[e] = this.elements[e].innerHTML),
          u(this.elements[e], this.vars, this.chars, this.words, this.lines);
